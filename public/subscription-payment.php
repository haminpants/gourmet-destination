        ...
        <form method="POST" action="subscription-payment-action.php">
            ...
            <div class="button-container">
                <div class="subscription-box">
                    ...
                    <a href="https://buy.stripe.com/test_dR69C09ud3As2bu7ss" class="pay-button" target="_blank">Subscribe Now</a>
                </div>

                <div class="subscription-box">
                    <label>Tourist Subscription</label>
                    <a href="https://buy.stripe.com/test_eVa3dC5dX0ogcQ8aEF" class="pay-button" target="_blank">Subscribe Now</a>
                </div>
            </div>
        </form>
    </div>
